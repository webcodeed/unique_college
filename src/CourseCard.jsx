...
const CourseCard = ({ 
  ...
  return (
    <motion.div 
      className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group border border-gray-100 flex flex-col h-full"
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-grow">
        <h3 className="text-xl font-semibold font-montserrat text-dark-gray mb-4 group-hover:text-primary-green transition-colors duration-300">
          {title}
        </h3>
        <p className="text-dark-gray text-sm lg:text-base font-roboto leading-relaxed mb-6 flex-grow line-clamp-4">
          {description}
        </p>
